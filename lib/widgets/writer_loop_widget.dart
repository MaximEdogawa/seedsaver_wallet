...
class WriterLoopWidget extends StatefulWidget {
  const WriterLoopWidget({
    super.key,
    this.text,
  ...
  @override
  State<WriterLoopWidget> createState() => _WriterLoopWidgetState();
}

class _WriterLoopWidgetState extends State<WriterLoopWidget>
